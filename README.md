...
ManageContacs Folder Contain  a folder which having Table Structure. Table needs to be created on SQL server with db name 'ManageContacts', along with table script attached in the folder(DBQueries).
