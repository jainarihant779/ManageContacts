...
I have create a basic application which will handle create update delete operation and show as well.
Please find below pre-requisite for the same.
...
ManageContacs Folder Contain  a folder which having Table Structure. Table needs to be created on SQL server with db name 'ManageContacts', along with table script attached in the folder(DBQueries).Another Folder called "Contacts" contain Code files for the same. 
This application built in Asp.net core. which belongs a MVC design pattern , dependency injection etc.
